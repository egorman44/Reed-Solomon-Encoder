...
```sh
git clone git@github.com:egorman44/Reed-Solomon-Encoder.git
cd Reed-Solomon-Encoder
```
...
#### Commit your changes
```sh
git commit -m 'Starting Reed-Solomon-Encoder'
...
```sh
./mill Reed-Solomon-Encoder.test
```
